...
def download(get_video_link=input_video_url.get() if input_video_url else None, get_audio_link=input_audio_url.get() if input_audio_url else None):
    ...
    if video_link:
        ...
        yvd.download() #example "C:\\Users\\Username\\Downloads\\Videos", by default downloaded-files are saved next to py file
    ...
    if audio_link:
        ...
        out_file = yad.download() #example "C:\\Users\\Username\\Downloads\\Audio", by default downloaded-files are saved next to py file
